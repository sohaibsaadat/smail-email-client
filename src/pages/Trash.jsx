...
const {filteredEmails} =useOutletContext()
  // Trash filter: strictly is_deleted === true
  const trashMails = emails.filter((email) => email.is_deleted === true);

  // Helper Function: HTML tags ko strip karke clean plain-text nikalne ke liye
  ...
  return (
    <div className="w-full">
      {filteredEmails.map((email) => {
        ...
        // Dynamic Display Name: Sent mail hone par Recipient, varna Sender
        ...
        return (
          ...
          >
            ...
            {/* Middle Section: Sender/Recipient, Subject, & Body Preview */}
